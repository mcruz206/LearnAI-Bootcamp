...
## Pre-work
There are a few tasks you must complete **before** the workshop begins. We will not add time for you to complete these tasks, so if you do not complete them ahead of time, you will be **30 minutes behind**. Before arriving at the workshop, you should have completed the tasks in the following labs:
...
2. Open "ImageProcessing.sln" which is under code>ImageProcessing. It may take a while for Visual Studio to open for the first time.
